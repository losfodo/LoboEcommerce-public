...
export default function Create({ parents, categories }) {
 ...
 useEffect(() => {
    if (product.parent) {
      const getParentData = async () => {
        try {
          ...
          // console.log('data {product.parent}', data);
          // console.log('/api/product/${product.parent}', product);
          if (data) {
            setProduct({
              ...product,
              name: data.name,
  ...
  }, [product.parent]); //}, [product.parent, setProduct, product]);
  ...
  useEffect(() => {
    ...
    //   console.log('/api/admin/subCategory', data);
      setSubs(data);
    }
    getSubs();
  }, [product.category]);
  ...
  let uploaded_images = [];//const uploaded_images = [];
  let style_img = "";//const style_img = "";
          ...
          <Form>
            ...
            {product.category && (
              <MultipleSelect
                ...
                name="subCategories"
                disabled={!!product.parent}//disabled={product.parent}
                handleChange={handleChange}
              />
            )}
