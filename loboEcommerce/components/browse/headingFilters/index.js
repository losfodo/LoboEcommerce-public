    ...
    <div className={styles.filters}>
      <div className={styles.filters__price}>
        ...
        <input
          ...
          disabled //deixando desabilitado pois pode dar problema no banco de dados
        />
        <input
          type="number"
          placeholder="max"
      ...
      <div className={styles.filers__priceBtns}>
        <Tooltip
          title={<h2>Confira produtos abaixo de 10R$</h2>}
          placement="top"
          arrow
        ...
        <Tooltip
          title={<h2>Confira produtos entre 10R$ e 50R$</h2>}
          placement="top"
          arrow
        ...
        <Tooltip
          title={<h2>Confira produtos entre 50R$ e 100R$</h2>}
          placement="top"
          arrow
        ...
        <Tooltip
          title={<h2>Confira produtos entre 100R$ e 500R$</h2>}
          placement="top"
          arrow
        ...
        <Tooltip
          title={<h2>Confira produtos por mais de 500R$</h2>}
          placement="top"
          arrow
